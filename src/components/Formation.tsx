      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-light text-foreground mb-6">
            Devenir <span className="italic text-primary">Praticien</span> Head Spa
          </h2>

          <p className="text-muted-foreground font-light leading-relaxed mb-10 max-w-2xl mx-auto">
            Vous souhaitez maîtriser l'art du Head Spa Japonais et en faire votre métier ? 
            Rejoignez notre formation certifiante et apprenez les techniques ancestrales 
